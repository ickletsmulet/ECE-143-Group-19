"""
This program is used to scrape each NBA team's win rates and separate into a
different file for each year between 1989 and 2019 for all NBA teams (31 years).
